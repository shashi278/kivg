...
class Kivg:
    ...
    def fill_up_shapes_anim(
        self, shapes: List[Tuple[List[float], List[float]]], *args
    ) -> None:
    ...
    def draw(
        ...
        **kwargs,
        ...
        if svg_file != self._previous_svg_file:
            self.svg_size, self.closed_shapes, self.path = (
                DrawingManager.process_path_data(svg_file)
            )
    ...
    def shape_animate(
        self,
        svg_file: str,
        anim_config_list: List[Dict] = None,
