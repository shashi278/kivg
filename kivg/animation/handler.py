...
class AnimationHandler:
    ...
    def create_animation_sequence(
        animations: List[Animation], sequential: bool = True
    ) -> Optional[Animation]:
        """
    ...
    @staticmethod
    def add_fill_animation(
        anim: Animation, widget: Any, on_progress_callback: Optional[Callable] = None
    ) -> Animation:
        """
        ...
        """
        fill_anim = Animation(
            d=DEFAULT_FILL_ANIMATION_DURATION, **{MESH_OPACITY_PROPERTY: 1}
        )
